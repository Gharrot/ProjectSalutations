...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ProjectSalutations", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ProjectSalutations", null, 480, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "716";
		app.meta["company"] = "Luc";
		app.meta["file"] = "ProjectSalutations";
		app.meta["name"] = "ProjectSalutations";
